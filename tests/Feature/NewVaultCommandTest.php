...
it('can set driver', function () {
    ...
    $this->artisan("vault:new --driver=local --vault-path=$test_vault_path")->assertExitCode(0);
...
it('errors when setting invalid driver', function () {
    ...
    $command = $this->artisan("vault:new --driver=invalid --vault-path=$test_vault_path");
